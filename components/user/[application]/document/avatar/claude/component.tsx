...
import { buildNumberedStructure, Node } from "./utils/hierarchy";
...
export function Claude({ applicationId, nodesData }: ClaudeProps) {
  const sendClaudeAction = useAction(api.application.machine.conversation.message.action.create.message); 
