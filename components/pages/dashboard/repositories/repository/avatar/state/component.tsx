...
export function MachineStatus({ repositoryId, machine }: MachineStatusProps) {
  const [isUpdating, setIsUpdating] = useState(false);
  const updateMachineState = useAction(api.githubAccount.repository.machine.action.update.machine);
