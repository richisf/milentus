...
import { RemoveRepository } from "@/components/pages/dashboard/repositories/repository/avatar/remove/component";
import { MachineStatus } from "@/components/pages/dashboard/repositories/repository/avatar/state/component";
