...
import { Remove } from "@/components/pages/user/applications/avatar/remove/component";
import { Machine } from "@/components/pages/user/application/avatar/machine/component";
