...
import { removeConvexProject } from "@/convex/githubAccount/application/machine/action/services/delete/convexProject";  
...
export const machine = internalAction({
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const deleteResult = await ctx.runMutation(internal.githubAccount.application.machine.mutation.delete.machine, {
