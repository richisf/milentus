...
import { machine as updateMachine } from "@/convex/githubAccount/application/machine/action/services/update";
...
export const machine = action({
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const updateResult = await ctx.runMutation(internal.githubAccount.application.machine.mutation.update.machine, {
        applicationId: args.applicationId,
        state: args.newState,
