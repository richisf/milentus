...
import { processMessageWithGemini } from "@/convex/githubAccount/application/document/action/update/services/message";  
...
export const processMessage = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    const existingDocument = await ctx.runQuery(internal.githubAccount.application.document.query.by_id.document, {
