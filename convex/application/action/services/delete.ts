  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      if (args.machine) {
        ...
        const machineRemoveResult = await ctx.runAction(internal.application.machine.action.delete.machine, {
      ...
      const repositoryRemoveResult = await ctx.runAction(internal.application.repository.action.delete.repository, {
      ...
      if (args.document) {
        ...
        const documentRemoveResult = await ctx.runAction(internal.application.document.action.delete.document, {
