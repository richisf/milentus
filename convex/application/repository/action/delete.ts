...
import { repository as deleteRepository } from "@/convex/application/repository/action/services/delete";
...
export const repository = internalAction({
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const repoDeleteResult = await ctx.runMutation(internal.application.repository.mutation.delete.repository, {
