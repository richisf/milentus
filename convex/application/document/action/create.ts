...
export const document = internalAction({
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const documentId = await ctx.runMutation(internal.application.document.mutation.create.document, {
      ...
      const conversationResult = await ctx.runAction(internal.application.document.conversation.action.create.conversation, {
        documentId
      });
