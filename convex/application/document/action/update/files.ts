...
import { processFilesWithGemini } from "@/convex/application/document/action/update/services/files";
...
export const document = internalAction({
  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      const createFilesResult = await ctx.runAction(internal.application.repository.files.action.create.files, {
