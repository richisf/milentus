  ...
  handler: async (ctx, args): Promise<{
    ...
    try {
      ...
      if (args.delete) {
        ...
        const messageProcessingResult = await ctx.runAction(internal.application.document.conversation.action.update.conversation, {
        ...
        const updatedDocument = await ctx.runQuery(internal.application.document.query.by_id.document, {
          documentId: args.documentId
        });
        ...
        const filesProcessingResult = await ctx.runAction(internal.application.document.action.update.files.document, {
      ...
      const updatedDocumentId = await ctx.runMutation(internal.application.document.mutation.update.document, mutationArgs);
